                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between gap-1">
                            <h4 class="mt-2">Listagem de permissões</h4>

                            <div>
                                @can(auth()->user()->can('permission.create'))
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                @if (empty($Permission->deleted_at))
                                                    ...
                                                    @endcan
                                                @else
                                                    @can(auth()->user()->can('permission.restore'))
