                            ...
                            <form method="POST" action="{{ route('admin.menu.store') }}" id="form-create">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <div class="row my-3 align-items-center">
                                            <label class="col-12 col-md-3 col-xxl-2 col-form-label required" for="route">Prefixo da rota :</label>
                                            <div class="col-12 col-md-9 col-xxl-10">
                                        ...
                                        <div class="row my-3 align-items-center">
                                            <label class="col-12 col-md-3 col-xxl-2 col-form-label" for="permission">Permissões :</label>
                                            <div class="col-12 col-md-9 col-xxl-10">
